...
#
# Assumes Azure PowerShell v0.8.0 - v0.9.8 (11/10/2015 - no longer necessary, Azure PowerShell v1 available on Web Platform Installer)
...
New-AzureRmResourceGroup –Name MyAutomationRG –Location “East US 2” 
