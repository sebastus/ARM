...
# ACTIVE DIRECTORY DC1 VM

Param(
  [string] $ResourceGroupLocation = 'West US',
  [string] $ResourceGroupName = 'ITInfrastructure',
  [switch] $UploadArtifacts,
  [string] $StorageAccountName, 
  [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
  [string] $TemplateFile = '..\Templates\DC1VMDeploymentTemplate.json',
  [string] $TemplateParametersFile = '..\Templates\DC1VMDeploymentTemplate.param.json',
